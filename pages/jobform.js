...
export async function getServerSideProps() {
    const res = await fetch('https://yomablogs-np65m.ondigitalocean.app/uploads/proanto/resume/state.json')
...
export default function PrivatePage(State, currentState) {
    ...
    const submitFeedback = async (event) => {
        ...
        xhr.open('POST', 'https://yomablogs-np65m.ondigitalocean.app/api/jobform/');
