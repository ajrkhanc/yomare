...
export async function getServerSideProps(context) {
    const post5 = await fetch('https://yoma-adminsc.herokuapp.com/api/posts')
    ...
    const res = await fetch(`https://yoma-adminsc.herokuapp.com/api/post/${posturl}`)
    const posts = await res.json()

    const getfeedback = await fetch(`https://yoma-adminsc.herokuapp.com/api/posts/feed/${posturl}`)
...
const submitFeedback = async (event) => {
    ...
    xhr.open('POST', 'https://yoma-adminsc.herokuapp.com/api/feedback/');
