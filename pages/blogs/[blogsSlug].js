...
export async function getServerSideProps(context) {
    const post5 = await fetch('https://yomablogs-jmwv.onrender.com/api/posts')
    ...
    const res = await fetch(`https://yomablogs-jmwv.onrender.com/api/post/${posturl}`)
    const posts = await res.json()

    const getfeedback = await fetch(`https://yomablogs-jmwv.onrender.com/api/posts/feed/${posturl}`)
...
const submitFeedback = async (event) => {
    ...
    xhr.open('POST', 'https://yomablogs-jmwv.onrender.com/api/feedback/');
